...
public:
    ...
    LazyFunction(Creator _creator) : m_creator(_creator) {}

    llvm::Value* call(IRBuilder& _builder, std::initializer_list<llvm::Value*> const& _args,
...
public:
    ...
    {
        m_setFunc.call(m_builder, {m_array, _index, _value});
    }
    ...
    {
        return m_getPtrFunc.call(m_builder, {_arrayPtr, _index});
    }
