...
public:
    ...
    virtual void notifyObjectCompiled(
        llvm::Module const* _module, llvm::MemoryBufferRef _object) final override;
    ...
    virtual std::unique_ptr<llvm::MemoryBuffer> getObject(
        llvm::Module const* _module) final override;
};
...
public:
    ...
    static std::unique_ptr<llvm::Module> getObject(
    ...
    static void preload(llvm::ExecutionEngine& _ee,
